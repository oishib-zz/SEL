...
game and all materials thereof are copyright 2016 by
Oishi Banerjee, Cameron Campbell, and the Stanford Gaming Society.
...
\paragraph{Game Times:} Game runs from 2pm to 6pm on {\bf \gamedate}, in the basement of building 200 (History corner). Surviving PCs are expected to be in-game for the entirety. Game may end early. Cleanup and Wrapup will immediately follow the end of game. Please plan to arrive by {\bf 1:30 pm} to get situated before the game starts. {\bf If you will be late, you must CALL the GMs and let us know. Oishi: (408)-930-; Cameron: (603)-913-5538.}
...
information and may not be discussed. Items cannot be destroyed unless you know otherwise. Keep only a reasonable number of 0-hand bulky items on your person. 5 is a reasonable number; 25 is not. Coins don't count.
...
\paragraph{Unstashable Items:} Unstashable items can't be hidden or left behind.  They look too important, valuable, or interesting; NPCs will not let them stay there.  These include any item that has a physrep. This is a kludge.  You can conceal unstashable items on your person, or store them in an in-game space that is marked as locked. If you're not leaving an unstashable item in another PC's care, and you want to leave it behind, give it to a GM or observer.  You may leave it in plain sight in a public area if there are other PCs around.
...
\paragraph{Stealing:} When searching someone who is paralyzed, restrained, or unconscious, you may automatically take whatever you find (other than money). Stealing someone's money takes somewhat longer: you may steal 50 gold coins by spending 30 seconds taking them. Stealing money in this way is interruptible.
...
scene to play the part of your corpse for five minutes; describe obvious information to
onlookers (``I have a gunshot wound in my back''). When you leave, stack your
items where you died, but keep your name-badge with you, and come see a GM. Until the
game is over, you may not convey game information to any player unless you know otherwise.
...
Unless you know otherwise, you cannot perform a killing blow. Being unconscious, paralyzed, or restrained makes you significantly more vulnerable to killing blows.
...
%% intro
All characters have a {\bf Combat Rating} ({\bf CR}) stat.  This represents your basic skill in martial combat; you use the same number for attacking and defending.  Someone with a CR of one can't fight very well.  Someone with a CR of three is in good physical shape; someone with a CR of four is particularly burly or skilled. When using this stat, you may pull your punches by using a lower number.

%% offense
To martial-attack someone, clearly state your attack and CR (``\aKnockOut{} 2'', etc.) from within ZoC.  You need the ability card for any attack you make; you don't have to display it.  Your attack must resolve before you make another; otherwise, you may act freely.  If an ally directs {\bf \aAssist{}} at you after you attack, you may, within 2 seconds, restate your attack with the \aAssist{}'s CR added (``\aKnockOut{} 3'', ``\aAssist{} 2'').  \aAssist{} does not change your CR for defense.  You may ignore an \aAssist{}.

Rope is not freely available in this game; to restrain someone, your character must remain near them and use one hand to keep them from moving. Knock Out attacks do not require any item.
...
abilities.  You should assume that every character has \aKnockOut{},  \aAssist{}, and \aRestrain{}.  Other attack
abilities may exist.\nopagebreak
...
You must hold the symbol for 10 seconds.  If you succeed, you may
replace your CR with ``waylay'' for a single immediate attack on your
victim.


\paragraph{Rope:} Once again, rope is \emph{not} freely available.
...
\begin{enumerate}
  ...
  \item Characters with solid-colored headbands that are not black or white are impossible to touch. In addition, you cannot see or hear them unless you know otherwise.
\end{enumerate}
