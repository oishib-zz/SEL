...
\NEW{Item}{\iWhatzit}{
 ...
 %\iBlackPen{}\iIphoneSeven{}\iBaseball{}\iTruffle{}\iYellowApple{}
  ...
  \s\MYcontents	{This is a phylactery. You realize this is a phylactery. The owner’s true name is Immundum. Power level: $\rule{1cm}{0.15mm}$}
  }
  \NEW{Item}{\iTruffle}{
  \s\MYname	{Truffle}
  \s\MYnumber	{0000}
 ...
 \NEW{ItemEnvelope}{\iWallet}{
  \s\MYname	{Wallet}
  \s\MYtext	{An empty leather wallet. Open if you touch.}
...
\NEW{ItemEnvelope}{\iiPhoneFour}{
  ...
  \s\MYcontents	{This is a phylactery. You realize this is a phylactery. The owner’s true name is Risus. Power level: $\rule{1cm}{0.15mm}$
  }
}
   \NEW{Item}{\iTabasco}{
  \s\MYname	{Tabasco}
  ...
  \s\MYcontents	{This is a phylactery. You realize this is a phylactery. The owner’s true name is Volantium. Power level: $\rule{1cm}{0.15mm}$
  }
  }
...
% \iKazoo{}\iSilverCoin{}\iRagDoll{}\iDates{}\iGrahamCrackers{}
 ...
 \NEW{ItemEnvelope}{\iKazoo}{
  ...
  \s\MYcontents	{This is a phylactery. You realize this is a phylactery. The owner’s true name is Astrorum. Power level: $\rule{1cm}{0.15mm}$
  }
  }
   \NEW{Item}{\iDates}{
  \s\MYname	{Dates}
  ...
  \s\MYcontents	{This is a phylactery. You realize this is a phylactery. The owner’s true name is Vetustius. Power level: $\rule{1cm}{0.15mm}$
  }
  }
  ...
  \s\MYcontents	{This is a phylactery. You realize this is a phylactery. The owner’s true name is Amorum. Power level: $\rule{1cm}{0.15mm}$
  }
  }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
