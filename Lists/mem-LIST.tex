...
\NEW{MemEnvelope}{\mCarminisSoulBond}{
  ...
  \s\MYtext	{A wave of giddy joy suddenly strikes you-- you are now Soul Bonded to Tyran!}
  \NEW{MemEnvelope}{\mTyranSoulBond}{
  \s\MYname	{Open this if you ever a lich with an alpha score of at least 100.}
  \s\MYtext	{A wave of giddy joy suddenly strikes you-- you are now Soul Bonded to Carminis!}
}
